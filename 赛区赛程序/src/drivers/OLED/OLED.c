...
{
	byte i=8;
	GPIOB_PDOR |=  GPIO_PDOR_PDO(GPIO_PIN(23));;;;
        asm("nop"); 
      GPIOB_PDOR &= ~GPIO_PDOR_PDO(GPIO_PIN(20));;;;
      asm("nop");    
  while(i--)
  {
    if(data&0x80){GPIOB_PDOR |=  GPIO_PDOR_PDO(GPIO_PIN(21));;;;}
    else{GPIOB_PDOR &= ~GPIO_PDOR_PDO(GPIO_PIN(21));;;;}
    GPIOB_PDOR |=  GPIO_PDOR_PDO(GPIO_PIN(20)); 
    asm("nop");;;;
		//asm("nop");            
    GPIOB_PDOR &= ~GPIO_PDOR_PDO(GPIO_PIN(20));;;;;    
...
void LCD_WrCmd(byte cmd)
{
  ...
  while(i--)
  {
    if(cmd&0x80){GPIOB_PDOR |=  GPIO_PDOR_PDO(GPIO_PIN(21));;;;;}
    else{GPIOB_PDOR &= ~GPIO_PDOR_PDO(GPIO_PIN(21));;;;;;}
    GPIOB_PDOR |=  GPIO_PDOR_PDO(GPIO_PIN(20));;;;;
    asm("nop");
		//asm("nop");             
...
void LCD_Init(void)        
{
	...
	GPIOB_PDOR &= ~GPIO_PDOR_PDO(GPIO_PIN(22));
	LCD_DLY_ms(50);
	GPIOB_PDOR |=  GPIO_PDOR_PDO(GPIO_PIN(22));
