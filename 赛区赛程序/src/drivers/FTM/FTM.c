...
{      	
    ...
    ASSERT( (ftmn==FTM0) || ( (ftmn==FTM1 || ftmn==FTM1 ) &&(ch<=CH1)) );   //检查传递进来的通道是否正确
  ...
  default:
    ...
    FTM_SC_PS：Prescale Factor Selection 预分频因子选择
                           | 100MHz   MOD=500     MOD=1000        MOD=2000
      000    Divide by 1   |            50k         25k             12.5k
      001    Divide by 2   |            25k        12.5k            6.25k
      010    Divide by 4   |           12.5k       6.25k
      011    Divide by 8   |           6.25k        3125
      100    Divide by 16  |            3125
      101    Divide by 32  |            1562.5
      110    Divide by 64  |
      111    Divide by 128 |
